...
namespace Venta.Infraestructura.Repositories.Base.EFConfigurations
{
    ...
    : IEntityTypeConfiguration<Dominio.Models.Venta>, IEntityTypeConfiguration<VentaDetalle>
    {
        public void Configure(EntityTypeBuilder<Dominio.Models.Venta> builder)
        {
